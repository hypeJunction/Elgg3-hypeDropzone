...
import {trigger, registerHandler} from 'elgg/events';
...
const dz = {
	...
	initDropzone: function (e) {
		...
		var params = trigger('config', 'dropzone', {dropzone: $input}, $input.data());
	...
	handleSuccess: function (files, data) {
		...
		$.each(files, function (index, file) {
			...
			trigger('upload:success', 'dropzone', {file: file, data: data});
		});
	},
	/**
...
registerHandler('config', 'dropzone', dz.config);
