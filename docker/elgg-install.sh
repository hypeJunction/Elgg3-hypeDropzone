...
# from <plugin>/docker/.env). Only that one plugin is activated.
...
SETTINGS_VALUES
    ...
    # Ensure www-data owns ALL data files created during install/activation
    # (FileCache, uploaded images, simplecache, etc.)
