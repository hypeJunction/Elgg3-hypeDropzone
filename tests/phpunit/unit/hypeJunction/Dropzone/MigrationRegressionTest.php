...
final class MigrationRegressionTest extends TestCase
{
    ...
    public function testManifestUsesStringLiterals(): void
    {
        ...
        // MyClass::SUBTYPE (a real class CONSTANT) in the entities block fatals.
        // NOTE: `\Fully\Qualified\Name::class` is a compile-time literal — the
        // compiler folds it to a string without ever loading the class, so it is
        // SAFE here (this plugin's entities block uses ::class deliberately). Only
        // flag class-constant access (::UPPER_SNAKE), never ::class.
        $src = self::manifestSource();
